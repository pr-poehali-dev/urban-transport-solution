...
const timeline = [
  {
    time: "14:30",
    event: "Сбор гостей",
    description: "Добро пожаловать! Вас встретят с бокалом шампанского в руках.",
  },
  {
    time: "14:00",
    event: "Церемония бракосочетания",
    description: "Торжественная регистрация в «Белом зале». Минута тишины и слова любви.",
  },
  {
    time: "16:00",
    event: "Фуршет и прогулка",
    description: "Лёгкие закуски, живая музыка и фотосессия в парке усадьбы.",
  },
  {
    time: "18:00",
    event: "Торжественный банкет",
    description: "Праздничный ужин, тосты и первый танец молодожёнов.",
  },
  {
    time: "21:00",
    event: "Танцы до утра",
    description: "Дискотека, торт и самые тёплые воспоминания на всю жизнь.",
  },
]
